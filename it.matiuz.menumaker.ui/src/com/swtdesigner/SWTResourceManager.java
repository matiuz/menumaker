...
public class SWTResourceManager
{
  ...
  {
    for (final Iterator<Color> iter = m_ColorMap.values ().iterator (); iter.hasNext ();)
      iter.next ().dispose ();
    m_ColorMap.clear ();
  }
  ...
  {
    final String key = section + '|' + SWTResourceManager.class.getName () + '|' + path;
  ...
  */
  ...
  {
    for (final Iterator<Image> I = m_ClassImageMap.values ().iterator (); I.hasNext ();)
      I.next ().dispose ();
    m_ClassImageMap.clear ();
    //
    for (final Iterator<HashMap<Image, Image>> I = m_ImageToDecoratorMap.values ().iterator (); I.hasNext ();)
    {
      final HashMap<Image, Image> decoratedMap = I.next ();
      for (final Iterator<Image> J = decoratedMap.values ().iterator (); J.hasNext ();)
      {
  ...
  */
  ...
  {
    // clear fonts
    for (final Iterator<Font> iter = m_FontMap.values ().iterator (); iter.hasNext ();)
      iter.next ().dispose ();
    m_FontMap.clear ();
    // clear bold fonts
    for (final Iterator<Font> iter = m_FontToBoldFontMap.values ().iterator (); iter.hasNext ();)
      iter.next ().dispose ();
  ...
  {
    for (final Iterator<Cursor> iter = m_IdToCursorMap.values ().iterator (); iter.hasNext ();)
      iter.next ().dispose ();
